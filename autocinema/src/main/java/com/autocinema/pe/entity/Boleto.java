...
public class Boleto {
	...
	public Boleto(Long id, Integer usuario, Integer funcion, Integer cantidad, Double total, Integer metodoP,
			Date fecha) {
		super();
		this.id = id;
	...
	public String toString() {
		return "boleto [id=" + id + ", usuario=" + usuario + ", funcion=" + funcion + ", cantidad=" + cantidad
